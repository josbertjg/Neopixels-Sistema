...
<body>
    <header>
        ...
        <div>
            <h1>Reporte de Servicios Inactivos</h1>
        </div>
    </header>
    <main>
        <table class="table table-bordered">
            ...
            <tbody>
                <?php 
                    include "../../PHP/db.php";
                    $query = "SELECT * FROM servicios_inactivos ORDER BY id ASC";
...
$bitacoras = new Bitacoras($_SESSION['correo'],"Abrió el reporte de Servicios Inactivos.");
