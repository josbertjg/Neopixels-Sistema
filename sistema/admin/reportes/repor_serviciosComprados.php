...
<body>
    <header>
        ...
        <div>
            <h1>Reporte de Servicios Comprados</h1>
        </div>
    </header>
    <main>
        <table class="table table-bordered">
            ...
            <tbody>
                <?php 
                    include "../../PHP/db.php";
                    $query = "SELECT * FROM servicios_comprados ORDER BY cantidad DESC";
...
$bitacoras = new Bitacoras($_SESSION['correo'],"Abrió el reporte de Servicios Comprados.");
